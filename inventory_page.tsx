...
function InventoryPage() {
  ...
  const handleAiSearch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { parsed_filters, success } = await response.json();
      ...
      newFilters.yearMin = parsed_filters.year?.gte ?? newFilters.yearMin;
      newFilters.yearMax = parsed_filters.year?.lte ?? newFilters.yearMax;
      newFilters.priceMin = parsed_filters.price?.gte ?? newFilters.priceMin;
      newFilters.priceMax = parsed_filters.price?.lte ?? newFilters.priceMax;
      newFilters.mileageMin = parsed_filters.mileage?.gte ?? newFilters.mileageMin;
      newFilters.mileageMax = parsed_filters.mileage?.lte ?? newFilters.mileageMax;
